 ...
 * @author User
 */
public class ReaderSearchByName extends javax.swing.JFrame {

    /**
     * Creates new form BookSearch
     */
    public ReaderSearchByName() {
        initComponents();
        setSize(1000, 1000); 
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            // TODO add your handling code here:
            String readerNama= jTextField1.getText();
            Reader reader =new Reader();
            ReaderContorl readercontorl=new ReaderContorl();
            List<Reader> listReader=new ArrayList<Reader>();
            listReader=readercontorl.RoughSelectReaderByReaderName(readerNama);
            //放在table中
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReaderSearchByName().setVisible(true);
            }
        });
    }

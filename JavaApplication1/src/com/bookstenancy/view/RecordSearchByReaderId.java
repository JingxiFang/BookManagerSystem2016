 ...
 * @author User
 */
public class RecordSearchByReaderId extends javax.swing.JFrame {

    /**
     * Creates new form RecordSearch
     */
    public RecordSearchByReaderId() {
        initComponents();
        setSize(599, 522);    
        //设置位置  
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            //获取姓名
            ReaderContorl reader=new ReaderContorl();
            String readerId=jTextField1.getText();
            String readerName=reader.SelectReaderNameById(readerId);
            if(readerName.equals(""))
            {
                jTextField2.setText("没有找到该读者");
                return;
            }
            jTextField2.setText(readerName);
            //查找该读者的借阅信息
            BorrowContorl borrowdao=new BorrowContorl();
            List<Borrow> listBorrow=new ArrayList<Borrow>();
            listBorrow=borrowdao.SelectBorrowByReaderID(readerId);
            ...
            for (int i=0;i<listBorrow.size();i++){
                ...
                arr[0]=Integer.toString(borrow.getBookId());
                arr[1]=borrow.getBookName();
            ...
            Logger.getLogger(RecordSearchByReaderId.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RecordSearchByReaderId.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RecordSearchByReaderId().setVisible(true);
            }
        });
    }

 ...
 * @author User
 */
public class BookTypeSearchAll extends javax.swing.JFrame {

    /**
     * Creates new form BookSearch
     */
    public BookTypeSearchAll() {
        initComponents();
        setSize(1000, 1000); 
    ...
    private void GetBookType(){
        try {
            ...
            BookTypeContorl readercontorl=new BookTypeContorl();
            List<BookType> listType=new ArrayList<BookType>();
            listType=readercontorl.SelectAllBookInfo();
            //放在table中
            ...
            for (int i=0;i<listType.size();i++){
                ...
                booktype=listType.get(i);
                arr[0]=String.valueOf(booktype.getId());
                arr[1]=booktype.getName();
                arr[2]=String.valueOf(booktype.getTypeStartHireRule());
                arr[3]=String.valueOf(booktype.getTypeEndHireRule());
                // 添加数据到表格
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BookTypeSearchAll().setVisible(true);
            }
        });
    }

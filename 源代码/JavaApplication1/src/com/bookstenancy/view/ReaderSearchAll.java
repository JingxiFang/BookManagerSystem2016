 ...
 * @author User
 */
public class ReaderSearchAll extends javax.swing.JFrame {

    /**
     * Creates new form BookSearch
     */
    public ReaderSearchAll() {
        initComponents();
        setSize(1000, 1000); 
    ...
    private void GetReaders(){
        try {
            ...
            listReader=readercontorl.SelectAllReaderInfo();
            //放在table中
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReaderSearchAll().setVisible(true);
            }
        });
    }

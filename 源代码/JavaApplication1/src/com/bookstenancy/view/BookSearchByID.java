 ...
 * @author User
 */
public class BookSearchByID extends javax.swing.JFrame {

    /**
     * Creates new form BookSearch
     */
    public BookSearchByID() {
        initComponents();
        setSize(610,800);    
        ...
        String path = "src/Images/BookSearch.jpg";  
    ...
    private void initComponents() {
        ...
        jLabel11.setFont(new java.awt.Font("等线", 0, 18)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            jTextField8.setText(String.valueOf(book.getCurInv()));
            jTextArea1.setText(book.getDescribe());
            }
            else
            {
            ...
            Logger.getLogger(BookSearchByID.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BookSearchByID.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BookSearchByID().setVisible(true);
            }
        });
    }

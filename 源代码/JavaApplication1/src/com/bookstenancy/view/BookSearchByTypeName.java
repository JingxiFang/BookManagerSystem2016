 ...
 * @author User
 */
public class BookSearchByTypeName extends javax.swing.JFrame {

    /**
     * Creates new form BookSearch
     */
    public BookSearchByTypeName() {
        initComponents();
        setSize(1000, 1000); 
    ...
    private void initComponents() {
        ...
        jComboBox1.setFont(new java.awt.Font("微软雅黑", 0, 24)); // NOI18N
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "普通图书", "新书", "计算机图书" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            String bookType= jComboBox1.getSelectedItem().toString();
            Book book =new Book();
            BookContorl bookcontorl=new BookContorl();
            List<Book> listBook=new ArrayList<Book>();
            listBook=bookcontorl.SelectBookByTypeName(bookType);
            //放在table中
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BookSearchByTypeName().setVisible(true);
            }
        });
    }
